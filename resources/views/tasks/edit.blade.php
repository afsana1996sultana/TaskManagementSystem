                        ...
                        <div class="row">
                            <div class="col-sm-12 pt-3">
                                <div class="input-group input_field">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" id="title" name="title" value="{{ $tasks->title }}" class="form-control" required>
                                        @error('title')
                            ...
                            <div class="col-sm-12 pt-3">
                                <div class="input-group input_field">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea name="description" id="description" rows="3" class="form-control @error('description') is-invalid @enderror">{{ $tasks->description }}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12 pt-3">
                                <div class="input-group input_field">
                                    <div class="col-sm-2"></div>
                                    <div class="col-sm-8">
                                        <button type="submit" class="add_btn btn btn-primary">Update</button>
                                    </div>
                                </div>
                            </div>
                        </div>
